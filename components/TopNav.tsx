    ...
    <header className="fixed inset-x-0 top-0 z-50 w-full">
      <div className="navbar bg-base-300">
        <div className="navbar-start">
          ...
          <div tabIndex={0} role="button" className="w-fit drawer-content btn text-base-content btn-ghost lg:hidden">
          ...
          <div className="drawer-side z-[1]">
            ...
            <ul className="menu bg-base-200 text-base-content min-h-full w-80 p-4">
              <li>
                <Link className="text-xl font-bold text-base-content" href="/">
              ...
              <li>
                <Link className="text-xl font-bold text-base-content" href="/about-me">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4">
          ...
          <div className="dropdown">
            ...
            <ul tabIndex={0} className="menu menu-lg dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-60 p-2 shadow">
              <li>
                <Link className="text-xl font-bold text-base-content" href="/">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4">
                    <path d="M8.543 2.232a.75.75 0 0 0-1.085 0l-5.25 5.5A.75.75 0 0 0 2.75 9H4v4a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-1a1 1 0 1 1 2 0v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1V9h1.25a.75.75 0 0 0 .543-1.268l-5.25-5.5Z" />
              ...
              <li>
                <Link className="text-xl font-bold text-base-content" href="/contact">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4">
                    <path fillRule="evenodd" d="m3.855 7.286 1.067-.534a1 1 0 0 0 .542-1.046l-.44-2.858A1 1 0 0 0 4.036 2H3a1 1 0 0 0-1 1v2c0 .709.082 1.4.238 2.062a9.012 9.012 0 0 0 6.7 6.7A9.024 9.024 0 0 0 11 14h2a1 1 0 0 0 1-1v-1.036a1 1 0 0 0-.848-.988l-2.858-.44a1 1 0 0 0-1.046.542l-.534 1.067a7.52 7.52 0 0 1-4.86-4.859Z" clipRule="evenodd" />
                  </svg>
                  Contact
          ...
          <input type="checkbox" value="winter" className="toggle theme-controller checkbox-secondary" aria-label="Theme Controller" />
        </div>
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1">
            <li>
              <Link className="text-xl font-bold text-base-content before:ease-linear relative overflow-hidden before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:before:-translate-x-40" href="/">
            ...
            <li>
              <Link className="text-xl font-bold text-base-content before:ease-linear relative overflow-hidden before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:before:-translate-x-40" href="/about-me">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="size-5">
            ...
            <li>
              <Link className="text-xl font-bold text-base-content before:ease-linear relative overflow-hidden before:absolute before:right-0 before:top-0 before:h-12 before:w-6 before:translate-x-12 before:rotate-6 before:bg-white before:opacity-10 before:duration-700 hover:before:-translate-x-40" href="/contact">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="size-5">
