    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="flex flex-col gap-4">
        <label htmlFor="name" className="input input-bordered input-primary flex items-center gap-2">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-4 fill-primary">
            <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM12.735 14c.618 0 1.093-.561.872-1.139a6.002 6.002 0 0 0-11.215 0c-.22.578.254 1.139.872 1.139h9.47Z" />
          </svg>
          <input {...register('name')} type="text" id="name" name="name" className="grow text-base-content" placeholder="Name" />
        </label>
        ...
        <label htmlFor="email" className="input input-bordered input-primary flex items-center gap-2">
          ...
          <input {...register('email')} type="email" id="email" name="email" className="grow text-base-content" placeholder="Email" />
        </label>
        {errors.email?.message && <FormError message={errors.email?.message} />}
        <textarea {...register('message')} id="message" name="message" className="textarea textarea-bordered textarea-primary textarea-lg flex text-base-content" placeholder="Message" ></textarea>
