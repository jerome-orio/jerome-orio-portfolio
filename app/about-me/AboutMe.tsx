...
const certifications = [
  { id: 'cert1', year: '2009', title: 'Oracle Certified Professional', desc: 'OCP - Forms Developer', issuer: 'Oracle Corporation' },
  { id: 'cert2', year: '2009', title: 'Oracle Certified Associate', desc: 'PL/SQL', issuer: 'Oracle Corporation' },
];

const page = {
  label: 'About Me',
  desc: 'I am a software developer with over 15 years of experience in creating and maintaining software solutions that help businesses run more efficiently. I enjoy working with teams to solve problems and deliver high-quality projects, even in fast-paced environments.\n\n'
        ...
        <div className="mb-2">
          <div className="flex justify-between flex-wrap gap-2 w-full">
            <span className="text-base-content font-bold">
              <Link className="link link-hover" href="https://cpi.com.ph" target="_blank" rel="noopener noreferrer">
