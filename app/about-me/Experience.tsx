...
const experience = [
  {
    id: 'exp1', position: 'Software Engineer', companyLink: 'https://www.kyndryl.com/us/en',
    companyName: 'Kyndryl', project: 'Project: Kyndryl Bridge - Security Operations as a Platform',
  ...
  {
    id: 'exp2', position: 'Software Engineer', companyLink: 'https://www.kyndryl.com/us/en',
    companyName: 'Kyndryl', project: 'Project: Unified Resiliency Platform - Backup as a Service',
  ...
  {
    id: 'exp3', position: 'Software Engineer', companyLink: 'https://www.ibm.com/consulting/business-continuity',
    companyName: 'IBM - Business Continuity Resiliency Services', project: 'Projects: IBM SmartCloud Managed Backup Portal, IBM SmartCloud Data Recovery, and IBM Client Connect Portal (Angular & React)',
  ...
  {
    id: 'exp4', position: 'Java Developer (J2EE)', companyLink: 'https://cpi.com.ph',
    companyName: 'Computer Professionals Inc.', project: 'Project: GeniiSys WEB (General Insurance Information System)',
  ...
  {
    id: 'exp5', position: 'Oracle Developer', companyLink: 'https://cpi.com.ph',
    companyName: 'Computer Professionals Inc.', project: 'GeniiSys Oracle (General Insurance Information System)',
                  ...
                  <div className="flex flex-wrap justify-start mt-4 gap-2">
                    {
                      item?.techStack?.map((tech, index) => (
                        <div key={index} className="badge badge-info badge-outline">{tech}</div>
                      ))
                    }
                  </div>
                </div>
